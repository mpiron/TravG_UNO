...
// //Si un joueur n'a pas de carte jouable, ne jouera pas et tour ne changera pas 

// //Ajouter dans jouerCarte() pour voir si carte est bien jouée :

// if (!empty($carteJouee)) {
//     echo "Carte jouée ! Nouveau tour: $tour";
// } else {
//     echo "Aucune carte jouée. Tour inchangé: $tour";
// }
